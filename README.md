...
1. Explain the difference between Relational Databases and SQL.
  Relational Databases are tables that store data points that can be associated to eachother. SQL is a programming language to query these databases.
2. Why do tables need a Primary Key?
Tables need a primary key so that each data point has a unique id.
3. What is the name given to a table column that references the Primary Key on another table?
A foreign key
4. What do we need in order to have a _many to many_ relationship between two tables?
An additional table that contains foreign keys for both of the original two tables
